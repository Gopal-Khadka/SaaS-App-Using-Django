...
STATICFILES_BASE_DIR.mkdir(
    exist_ok=True, parents=True
)  # creates the directory staticfiles if it doesn't already exist
...
# Refer to: https://whitenoise.readthedocs.io/en/stable/django.html#add-compression-and-caching-support
STORAGES = {
    "staticfiles": {
